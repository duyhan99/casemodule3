...
<%@ page import="com.case1.case1.model.Message"%>
<%@ page import="com.case1.case1.dao.UserDAO"%>
<%
...
%>
    ...
    <div class="row justify-content-start">
        ...
        <h5>
            <%= new UserDAO().getUserById(Integer.parseInt(messages.get(i).getFrom_user())).getFirst_name() %>
            <a href="${pageContext.request.contextPath}/view-message?id=<%= request.getAttribute("to_user") %>&delete=<%= messages.get(i).getChat_id() %>" class="card-link" style="float: right;"><i
                style="color: red;" class="far fa-trash-alt"></i></a>
        </h5>
        <%= messages.get(i).getMessage() %>
        <p style="text-align: right;"><%= messages.get(i).getChat_time() %></p>

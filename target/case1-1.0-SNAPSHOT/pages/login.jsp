    ...
    <div class="login-html">
        <input id="tab-1" type="radio" name="tab" class="sign-in"
               <%
						...
						%> >
        <label for="tab-1" class="tab">Sign In</label> <input id="tab-2" type="radio" name="tab" class="sign-up" <%
							if(request.getAttribute("page") != null){
        ...
        <div class="login-form">
            <div class="sign-in-htm">
                <form method="post" action="${pageContext.request.contextPath}/login">
                    <div class="group">
                        <%--@declare id="user"--%><label for="user" class="label">Email</label> <input id="email"
                                                                             name="email" type="text" class="input">
                    </div>
                    <div class="group">
                        <%--@declare id="pass"--%><label for="pass" class="label">Password</label> <input
                            type="password" id="passwordd" name="password" class="input"
                            data-type="password">
                    </div>
                    <div class="group">
                ...
                <form method="post" action="${pageContext.request.contextPath}/register">
                    ...
                    <div class="group">
                        <label for="pass" class="label">Email
                            ...
                            %></label>
                        <input id="emaill" name="email" type="text" class="input">
